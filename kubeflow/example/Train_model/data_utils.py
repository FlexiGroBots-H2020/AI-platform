...
class AgroVisionDataSet(Dataset):
    def __init__(self, img_size,
        ...
        print("333333333333 img paths 1 33333333333")
        print(img_paths_1)
        print("3333333333 img paths3333333333333")
        print(img_paths)
        print("33333333 img names333333333333333")
        print(self.img_names)
        print("3333333 root dir 3333333333333333")
        print(root_dir)
    ...
    def __getitem__(self, idx):
        ...
        if self.binary:
            label = torch.from_numpy(np.ascontiguousarray(
                np.load(os.path.join('label', img_name+'_mask' + self.data_format), allow_pickle=False).astype(
                    np.float32))).to(self.device)
