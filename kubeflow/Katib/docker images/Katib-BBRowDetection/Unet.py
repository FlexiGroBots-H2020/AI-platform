...
class encoder(nn.Module):
    def __init__(self, in_channels, out_channels):
        ...
        self.pool = nn.MaxPool2d(kernel_size=2, return_indices=False, ceil_mode=True)
...
class UNetResnet(BaseModel):
    def __init__(self, num_classes, in_channels=3, backbone='resnet50', pretrained=True, freeze_bn=False,
        ...
        if in_channels != 3:
            self.initial[0][0] = nn.Conv2d(in_channels, 64, kernel_size=7, stride=2, padding=3, bias=False)
