...
from utils_calc_zones import statistics_from_map, create_shp_multipolygon_from_raster, create_vegetation_index_map
...
def zone_estimation(in_raster_red,
    ...
    try:
        ...
        veg_idx_tag = 'NDVI'
        create_vegetation_index_map(in_raster_red,NDVI,folder_name,veg_idx_tag,y_start,y_end,x_start,x_end)
        veg_idx_tag = 'WDRVI'
        create_vegetation_index_map(in_raster_red,WDRVI,folder_name,veg_idx_tag,y_start,y_end,x_start,x_end)
        veg_idx_tag = 'GLI'
        create_vegetation_index_map(in_raster_red,GLI,folder_name,veg_idx_tag,y_start,y_end,x_start,x_end)
